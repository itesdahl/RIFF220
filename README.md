...
>[!TIP]
>Use the Voron Trident assembly guide to build the bed arms and the A/B motor mounts. Please note that the orientation of some bolts are different from the original. Check the threads.. https://github.com/VoronDesign/Voron-Trident/blob/main/Manual/Assembly_Manual_Trident.pdf 

Refer to the BFI idlers to print the original STLs for carrier and front. https://github.com/clee/VoronBFI
>
